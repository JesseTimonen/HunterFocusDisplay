...
function saveOptions()
    ...
    for key,value in pairs(options) do
        if (key ~= "xPos"
        and key ~= "yPos"
        and key ~= "focusBarHeight"
        and key ~= "focusBarGap"
        and key ~= "focusBarLenght"
...
function loadOptions()
    ...
    if _options ~= nil then
        ...
        if (_options["focusBarHeight"] == nil) then
            _options["focusBarHeight"] = options["focusBarHeight"];
        end

        if (_options["focusBarGap"] == nil) then
            _options["focusBarGap"] = options["focusBarGap"];
        end

        if (_options["focusBarLenght"] == nil) then
            _options["focusBarLenght"] = options["focusBarLenght"];
        end
